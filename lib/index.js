...
function memoizeResolveFn(literal, argsGetter, cacheDepsGetter, resolveFn) {
    ...
    return function ($transition$) {
        ...
        function continuation(getterArgs) {
            ...
            var args = core_1.extend({}, cacheDeps, argsGetter.apply(void 0, deps));
            if (core_1.equals(args, lastArgs) && $resolveCache.isCached(literal)) {
                return lastRes;
            }
            lastArgs = args;
            ...
            if (skipIfTests.length) {
                resolveFn = skipIfTests.reduce(function (res, _a) {
                    ...
                    return function ($transition$) {
                        ...
                        if (core_1.any(core_1.isPromise)(resolvedDeps)) {
